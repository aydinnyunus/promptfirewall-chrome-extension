...
function generateUniqueRandomCreditCard() {
  ...
  function isValidDiscover(number) {
    return (
      number.toString().length === 16 && number.toString().startsWith("6011")
    );
  }
...
function generateUniqueRandomCryptoAddress() {
  ...
  const addressFormat =
    addressFormats[Math.floor(Math.random() * addressFormats.length)];
...
function generateUniqueRandomIBAN() {
  ...
  const iban =
    countryCode + randomAccountNumber.toString().padStart(ibanLength, "0");
  return iban;
}
...
function generateUniqueRandomABARTN() {
  ...
  const firstTwoDigits =
    firstTwoDigitsOptions[
      Math.floor(Math.random() * firstTwoDigitsOptions.length)
    ];
...
function generateUniqueRandomFranceVATNumber() {
  ...
  if (format === 2)
    return digits.charAt(0) + letters.charAt(1) + digits.slice(1);
...
function generateUniqueRandomUKBICNumber() {
  ...
  return (
    ...
    Array.from(
      ...
      () => chars.charAt(Math.floor(Math.random() * 36))
    ).join("") +
    Array.from(
      {
        length: 3,
...
function generateUniqueRandomUKPostcode() {
  ...
  if (format === 2)
    return (
      chars.charAt(Math.floor(Math.random() * 26)) +
      chars.charAt(Math.floor(Math.random() * 8)) +
      digits.charAt(Math.floor(Math.random() * 10)) +
      " " +
      digits.charAt(Math.floor(Math.random() * 10)) +
      chars.charAt(Math.floor(Math.random() * 26)) +
...
function generateUniqueRandomUKSEDOL() {
  ...
  return Array.from(
    ...
    () => chars.charAt(Math.floor(Math.random() * 33))
  ).join("");
}
  ...
  if (format === 29)
    return (
      Array.from(
        ...
        () => digits.charAt(Math.floor(Math.random() * 10))
      ).join("") + chars.charAt(Math.floor(Math.random() * 26))
    );
  if (format === 30)
    return (
      Array.from(
...
function generateUniqueRandomINN() {
  const firstNineDigits = Math.floor(100000000 + Math.random() * 900000000)
    .toString()
    .padStart(9, "0");
  const checksum = Math.floor(10 + Math.random() * 90)
    .toString()
    .padStart(2, "0");
  const separator = Math.random() > 0.5 ? " " : "-";
  return `${firstNineDigits.substring(0, 3)}-${firstNineDigits.substring(
    3,
    6
  )}-${firstNineDigits.substring(6, 9)}${separator}${checksum}`;
}
...
debug(
  "Random Australian Business Number:",
  generateUniqueRandomAustralianBusinessNumber()
);
debug(
  "Random Australian Company Number:",
  generateUniqueRandomAustralianCompanyNumber()
);
debug(
  "Random Australian Drivers License:",
  generateUniqueRandomAustralianDriversLicense()
);
debug(
  "Random Australian Full National Number:",
  generateUniqueRandomAustralianFullNationalNumber()
);
debug(
  "Random Australian Medicare Card Number:",
  generateUniqueRandomAustralianMedicareCardNumber()
);
debug(
  "Random Australian NSW Drivers License:",
  generateUniqueRandomAustralianNSWDriversLicense()
);
debug(
  "Random Australian QLD Drivers License:",
  generateUniqueRandomAustralianQLDDriversLicense()
);
debug(
  "Random Australian Tax File Number:",
  generateUniqueRandomAustralianTaxFileNumber()
);
debug(
  "Random Austrian Bank Account Number:",
  generateUniqueRandomAustrianBankAccountNumbers()
);
debug(
  "Random Austrian Passport Number:",
  generateUniqueRandomAustrianPassportNumber()
);
debug(
  "Random Austrian Social Security Insurance Number:",
  generateUniqueRandomAustrianSocialSecurityInsuranceNumber()
);
debug("Random Austrian VAT Number:", generateUniqueRandomAustrianVATNumber());
debug(
  "Random Canadian Alberta Drivers License:",
  generateUniqueRandomCanadianAlbertaDriversLicense()
);
debug(
  "Random Canadian Alberta Health Number:",
  generateUniqueRandomCanadianAlbertaHealth()
);
debug(
  "Random Canadian Manitoba Drivers License:",
  generateUniqueRandomCanadianManitobaDriversLicense()
);
debug(
  "Random Canadian Manitoba Health Number:",
  generateUniqueRandomCanadianManitobaHealth()
);
debug(
  "Random Canadian Ontario Drivers License:",
  generateUniqueRandomCanadianOntarioDriversLicense()
);
debug(
  "Random Canadian Ontario Health Number:",
  generateUniqueRandomCanadianOntarioHealth()
);
debug(
  "Random Canadian Passport Number:",
  generateUniqueRandomCanadianPassport()
);
debug(
  "Random Canadian Quebec Drivers License:",
  generateUniqueRandomCanadianQuebecDriversLicense()
);
debug(
  "Random Canadian Quebec Health Number:",
  generateUniqueRandomCanadianQuebecHealth()
);
debug(
  "Random Canadian Saskatchewan Drivers License:",
  generateUniqueRandomCanadianSaskatchewanDriversLicense()
);
debug(
  "Random Canadian Social Insurance Number:",
  generateUniqueRandomCanadianSocialInsuranceNumber()
);
debug("Random Date Format:", generateUniqueRandomDateFormats());
debug(
  "Random France Drivers License Number:",
  generateUniqueRandomFranceDriversLicenseNumber()
);
debug(
  "Random France Passport Number:",
  generateUniqueRandomFrancePassportNumber()
);
...
debug(
  "Random German Drivers License Number:",
  generateUniqueRandomGermanDriversLicenseNumber()
);
debug("Random German ID Number:", generateUniqueRandomGermanIDNumber());
debug(
  "Random German Passport Number:",
  generateUniqueRandomGermanPassportNumber()
);
debug(
  "Random German Social Security Number:",
  generateUniqueRandomGermanSocialSecurityNumber()
);
debug(
  "Random German Tax Identifier:",
  generateUniqueRandomGermanTaxIdentifier()
);
debug(
  "Random Indian Aadhaar Number:",
  generateUniqueRandomIndianAadhaarNumber()
);
debug("Random Indian PAN:", generateUniqueRandomIndianPAN());
debug(
  "Random Italian Passport Number:",
  generateUniqueRandomItalianPassportNumber()
);
...
debug(
  "Random UK Driver License Number:",
  generateUniqueRandomUKDriverLicenseNumber()
);
debug(
  "Random UK Electoral Roll Number:",
  generateUniqueRandomUKElectoralRollNumber()
);
...
debug(
  ...
  generateUniqueRandomUKNationalInsuranceNumber()
);
...
debug(
  "Random US Driver License Number:",
  generateUniqueRandomUSDriverLicenseNumber()
);
debug("Random US ITIN:", generateUniqueRandomUSITIN());
debug(
  "Random US Medicare HIC Number:",
  generateUniqueRandomUSMedicareHICNumber()
);
...
function matchCreditCardNumbers(text) {
  ...
  const regex =
    /\b(?:\d{4}[ -]?){3}(?=\d{4}\b)(?:\d{4})|3[47][0-9]{2}([ -]?)([0-9]{6}\1[0-9]{5})\b/g;
...
function matchPhoneNumbers(text) {
  ...
  const regex =
    /\b(\+\d{1,2}\s?)?1?\-?\.?\s?\(?\d{3}\)?[\s.-]?\d{3}[\s.-]?\d{4}\b/g;
...
function matchFranceDriversLicenseNumber(text) {
  ...
  const regex =
    /\b[0-9]{2}(?:0[1-9]|1[0-2])(?:0[1-9]|1[0-9]|2A|2a|2B|2b|2[1-9]|[3-8][0-9]|9[0-5])[0-9]{6}\b/g;
  return text.match(regex);
}
...
function matchItalianTaxID(text) {
  ...
  const regex =
    /\b[A-Z]{3}[ -]?[A-Z]{3}[ -]?[0-9]{2}[A-EHLMPRST](?:[04][1-9]|[1256][0-9]|[37][01])[ -]?[A-MZ][0-9]{3}[A-Z]\b/g;
  return text.match(regex);
}
...
function matchUKDriverLicenseNumber(text) {
  ...
  const regex =
    /\b[A-Z0-9]{5}\d[0156]\d([0][1-9]|[12]\d|3[01])\d[A-Z0-9]{3}[A-Z]{2}\b/g;
  return text.match(regex);
}
...
function matchUKUTR(text) {
  ...
  const regexArray = [/\b\d{5} \d{5}\b/g, /\b\d{10}\b/g];
  return regexArray.flatMap((regex) => text.match(regex) || []);
}
...
function matchUSPassportNumber(text) {
  ...
  const regexArray = [/\b\d{8}\b/g, /\b\d{9}\b/g];
  return regexArray.flatMap((regex) => text.match(regex) || []);
}

// US Social Security Number (SSN)
//regex101.com/r/kdXrYe/1
https: function matchUSSSN(text) {
  if (typeof text !== "string") {
    debug("Expected a string but received:", typeof text);
    text = "";
  }
...
function matchClosest(text) {
  ...
  targets.forEach((target) => {
    const distance = optimizedLevenshtein(
      text.toLowerCase(),
      target.toLowerCase()
    );
        ...
        textarea.addEventListener(
          ...
          debounce(async (event) => {
            ...
            if (paragraphs.length > 0) {
              fullTextContent = Array.from(paragraphs)
                .map((p) => p.textContent)
                .join(" ");
            } else {
            ...
            if (!isSendingData) {
              ...
              const matchPhoneNumbersStr = safeMatch(
                matchPhoneNumbers,
                lastPart
              );
              debug("matchPhoneNumbersStr", matchPhoneNumbersStr);
              const matchCryptoAddressesStr = safeMatch(
                matchCryptoAddresses,
                lastPart
              );
              debug("matchCryptoAddressesStr", matchCryptoAddressesStr);
              const matchEmailAddressesStr = safeMatch(
                matchEmailAddresses,
                lastPart
              );
              ...
              const matchCreditCardNumbersStr = safeMatch(
                matchCreditCardNumbers,
                lastPart
              );
              ...
              const matchAustralianBusinessNumberStr = safeMatch(
                matchAustralianBusinessNumber,
                lastPart
              );
              debug(
                "matchAustralianBusinessNumberStr",
                matchAustralianBusinessNumberStr
              );
              const matchAustralianCompanyNumberStr = safeMatch(
                matchAustralianCompanyNumber,
                lastPart
              );
              debug(
                "matchAustralianCompanyNumberStr",
                matchAustralianCompanyNumberStr
              );
              const matchAustralianDriversLicenseStr = safeMatch(
                matchAustralianDriversLicense,
                lastPart
              );
              debug(
                "matchAustralianDriversLicenseStr",
                matchAustralianDriversLicenseStr
              );
              const matchAustralianFullNationalNumberStr = safeMatch(
                matchAustralianFullNationalNumber,
                lastPart
              );
              debug(
                "matchAustralianFullNationalNumberStr",
                matchAustralianFullNationalNumberStr
              );
              const matchAustralianMedicareCardNumberStr = safeMatch(
                matchAustralianMedicareCardNumber,
                lastPart
              );
              debug(
                "matchAustralianMedicareCardNumberStr",
                matchAustralianMedicareCardNumberStr
              );
              const matchAustralianNSWDriversLicenseStr = safeMatch(
                matchAustralianNSWDriversLicense,
                lastPart
              );
              debug(
                "matchAustralianNSWDriversLicenseStr",
                matchAustralianNSWDriversLicenseStr
              );
              const matchAustralianQLDDriversLicenseStr = safeMatch(
                matchAustralianQLDDriversLicense,
                lastPart
              );
              debug(
                "matchAustralianQLDDriversLicenseStr",
                matchAustralianQLDDriversLicenseStr
              );
              const matchAustralianTaxFileNumberStr = safeMatch(
                matchAustralianTaxFileNumber,
                lastPart
              );
              debug(
                "matchAustralianTaxFileNumberStr",
                matchAustralianTaxFileNumberStr
              );
              const matchAustrianBankAccountNumbersStr = safeMatch(
                matchAustrianBankAccountNumbers,
                lastPart
              );
              debug(
                "matchAustrianBankAccountNumbersStr",
                matchAustrianBankAccountNumbersStr
              );
              const matchAustrianPassportNumberStr = safeMatch(
                matchAustrianPassportNumber,
                lastPart
              );
              debug(
                "matchAustrianPassportNumberStr",
                matchAustrianPassportNumberStr
              );
              const matchAustrianSocialSecurityInsuranceNumberStr = safeMatch(
                matchAustrianSocialSecurityInsuranceNumber,
                lastPart
              );
              debug(
                "matchAustrianSocialSecurityInsuranceNumberStr",
                matchAustrianSocialSecurityInsuranceNumberStr
              );
              const matchAustrianVATNumberStr = safeMatch(
                matchAustrianVATNumber,
                lastPart
              );
              debug("matchAustrianVATNumberStr", matchAustrianVATNumberStr);
              const matchCanadianAlbertaDriversLicenseStr = safeMatch(
                matchCanadianAlbertaDriversLicense,
                lastPart
              );
              debug(
                "matchCanadianAlbertaDriversLicenseStr",
                matchCanadianAlbertaDriversLicenseStr
              );
              const matchCanadianAlbertaHealthStr = safeMatch(
                matchCanadianAlbertaHealth,
                lastPart
              );
              debug(
                "matchCanadianAlbertaHealthStr",
                matchCanadianAlbertaHealthStr
              );
              const matchCanadianManitobaDriversLicenseStr = safeMatch(
                matchCanadianManitobaDriversLicense,
                lastPart
              );
              debug(
                "matchCanadianManitobaDriversLicenseStr",
                matchCanadianManitobaDriversLicenseStr
              );
              const matchCanadianManitobaHealthStr = safeMatch(
                matchCanadianManitobaHealth,
                lastPart
              );
              debug(
                "matchCanadianManitobaHealthStr",
                matchCanadianManitobaHealthStr
              );
              const matchCanadianOntarioDriversLicenseStr = safeMatch(
                matchCanadianOntarioDriversLicense,
                lastPart
              );
              debug(
                "matchCanadianOntarioDriversLicenseStr",
                matchCanadianOntarioDriversLicenseStr
              );
              const matchCanadianOntarioHealthStr = safeMatch(
                matchCanadianOntarioHealth,
                lastPart
              );
              debug(
                "matchCanadianOntarioHealthStr",
                matchCanadianOntarioHealthStr
              );
              const matchCanadianPassportStr = safeMatch(
                matchCanadianPassport,
                lastPart
              );
              debug("matchCanadianPassportStr", matchCanadianPassportStr);
              const matchCanadianQuebecDriversLicenseStr = safeMatch(
                matchCanadianQuebecDriversLicense,
                lastPart
              );
              debug(
                "matchCanadianQuebecDriversLicenseStr",
                matchCanadianQuebecDriversLicenseStr
              );
              const matchCanadianQuebecHealthStr = safeMatch(
                matchCanadianQuebecHealth,
                lastPart
              );
              debug(
                "matchCanadianQuebecHealthStr",
                matchCanadianQuebecHealthStr
              );
              const matchCanadianSaskatchewanDriversLicenseStr = safeMatch(
                matchCanadianSaskatchewanDriversLicense,
                lastPart
              );
              debug(
                "matchCanadianSaskatchewanDriversLicenseStr",
                matchCanadianSaskatchewanDriversLicenseStr
              );
              const matchCanadianSocialInsuranceNumberStr = safeMatch(
                matchCanadianSocialInsuranceNumber,
                lastPart
              );
              debug(
                "matchCanadianSocialInsuranceNumberStr",
                matchCanadianSocialInsuranceNumberStr
              );
              const matchDateFormatsStr = safeMatch(matchDateFormats, lastPart);
              debug("matchDateFormatsStr", matchDateFormatsStr);
              const matchFranceDriversLicenseNumberStr = safeMatch(
                matchFranceDriversLicenseNumber,
                lastPart
              );
              debug(
                "matchFranceDriversLicenseNumberStr",
                matchFranceDriversLicenseNumberStr
              );
              const matchFrancePassportNumberStr = safeMatch(
                matchFrancePassportNumber,
                lastPart
              );
              debug(
                "matchFrancePassportNumberStr",
                matchFrancePassportNumberStr
              );
              const matchFranceVATNumberStr = safeMatch(
                matchFranceVATNumber,
                lastPart
              );
              debug("matchFranceVATNumberStr", matchFranceVATNumberStr);
              const matchFrenchINSEECodeStr = safeMatch(
                matchFrenchINSEECode,
                lastPart
              );
              debug("matchFrenchINSEECodeStr", matchFrenchINSEECodeStr);
              const matchGermanDriversLicenseNumberStr = safeMatch(
                matchGermanDriversLicenseNumber,
                lastPart
              );
              debug(
                "matchGermanDriversLicenseNumberStr",
                matchGermanDriversLicenseNumberStr
              );
              const matchGermanIDNumberStr = safeMatch(
                matchGermanIDNumber,
                lastPart
              );
              debug("matchGermanIDNumberStr", matchGermanIDNumberStr);
              const matchGermanPassportNumberStr = safeMatch(
                matchGermanPassportNumber,
                lastPart
              );
              debug(
                "matchGermanPassportNumberStr",
                matchGermanPassportNumberStr
              );
              const matchGermanSocialSecurityNumberStr = safeMatch(
                matchGermanSocialSecurityNumber,
                lastPart
              );
              debug(
                "matchGermanSocialSecurityNumberStr",
                matchGermanSocialSecurityNumberStr
              );
              const matchGermanTaxIdentifierStr = safeMatch(
                matchGermanTaxIdentifier,
                lastPart
              );
              debug("matchGermanTaxIdentifierStr", matchGermanTaxIdentifierStr);
              const matchIndianAadhaarNumberStr = safeMatch(
                matchIndianAadhaarNumber,
                lastPart
              );
              ...
              const matchItalianPassportNumberStr = safeMatch(
                matchItalianPassportNumber,
                lastPart
              );
              debug(
                "matchItalianPassportNumberStr",
                matchItalianPassportNumberStr
              );
              const matchItalianTaxIDStr = safeMatch(
                matchItalianTaxID,
                lastPart
              );
              ...
              const matchUKDriverLicenseNumberStr = safeMatch(
                matchUKDriverLicenseNumber,
                lastPart
              );
              debug(
                "matchUKDriverLicenseNumberStr",
                matchUKDriverLicenseNumberStr
              );
              const matchUKElectoralRollNumberStr = safeMatch(
                matchUKElectoralRollNumber,
                lastPart
              );
              debug(
                "matchUKElectoralRollNumberStr",
                matchUKElectoralRollNumberStr
              );
              const matchUKIBANNumberStr = safeMatch(
                matchUKIBANNumber,
                lastPart
              );
              ...
              const matchUKNationalInsuranceNumberStr = safeMatch(
                matchUKNationalInsuranceNumber,
                lastPart
              );
              debug(
                "matchUKNationalInsuranceNumberStr",
                matchUKNationalInsuranceNumberStr
              );
              const matchUKPassportNumberStr = safeMatch(
                matchUKPassportNumber,
                lastPart
              );
              ...
              const matchUSDriverLicenseNumberStr = safeMatch(
                matchUSDriverLicenseNumber,
                lastPart
              );
              debug(
                "matchUSDriverLicenseNumberStr",
                matchUSDriverLicenseNumberStr
              );
              const matchUSITINStr = safeMatch(matchUSITIN, lastPart);
              debug("matchUSITINStr", matchUSITINStr);
              const matchUSMedicareHICNumberStr = safeMatch(
                matchUSMedicareHICNumber,
                lastPart
              );
              debug("matchUSMedicareHICNumberStr", matchUSMedicareHICNumberStr);
              const matchUSPassportNumberStr = safeMatch(
                matchUSPassportNumber,
                lastPart
              );
              ...
              const matchUSSSNRandomizationStr = safeMatch(
                matchUSSSNRandomization,
                lastPart
              );
              ...
              const matchCodiceFiscaleStr = safeMatch(
                matchCodiceFiscale,
                lastPart
              );
              ...
              let cnt =
                (matchPhoneNumbersStr && matchPhoneNumbersStr.length > 0
                  ? matchPhoneNumbersStr.length
                  : 0) +
                (matchCryptoAddressesStr && matchCryptoAddressesStr.length > 0
                  ? matchCryptoAddressesStr.length
                  : 0) +
                (matchEmailAddressesStr && matchEmailAddressesStr.length > 0
                  ? matchEmailAddressesStr.length
                  : 0) +
                (matchIBANCodesStr && matchIBANCodesStr.length > 0
                  ? matchIBANCodesStr.length
                  : 0) +
                (matchIPAddressesStr && matchIPAddressesStr.length > 0
                  ? matchIPAddressesStr.length
                  : 0) +
                (matchCreditCardNumbersStr &&
                matchCreditCardNumbersStr.length > 0
                  ? matchCreditCardNumbersStr.length
                  : 0) +
                (matchSecretTokenStr && matchSecretTokenStr.length > 0
                  ? matchSecretTokenStr.length
                  : 0) +
                (matchMarkdownStr && matchMarkdownStr.length > 0
                  ? matchMarkdownStr.length
                  : 0) +
                (matchClosestStr && matchClosestStr.length > 0
                  ? matchClosestStr.length
                  : 0) +
                (matchABARTNStr && matchABARTNStr.length > 0
                  ? matchABARTNStr.length
                  : 0) +
                (matchAustralianBusinessNumberStr &&
                matchAustralianBusinessNumberStr.length > 0
                  ? matchAustralianBusinessNumberStr.length
                  : 0) +
                (matchAustralianCompanyNumberStr &&
                matchAustralianCompanyNumberStr.length > 0
                  ? matchAustralianCompanyNumberStr.length
                  : 0) +
                (matchAustralianDriversLicenseStr &&
                matchAustralianDriversLicenseStr.length > 0
                  ? matchAustralianDriversLicenseStr.length
                  : 0) +
                (matchAustralianFullNationalNumberStr &&
                matchAustralianFullNationalNumberStr.length > 0
                  ? matchAustralianFullNationalNumberStr.length
                  : 0) +
                (matchAustralianMedicareCardNumberStr &&
                matchAustralianMedicareCardNumberStr.length > 0
                  ? matchAustralianMedicareCardNumberStr.length
                  : 0) +
                (matchAustralianNSWDriversLicenseStr &&
                matchAustralianNSWDriversLicenseStr.length > 0
                  ? matchAustralianNSWDriversLicenseStr.length
                  : 0) +
                (matchAustralianQLDDriversLicenseStr &&
                matchAustralianQLDDriversLicenseStr.length > 0
                  ? matchAustralianQLDDriversLicenseStr.length
                  : 0) +
                (matchAustralianTaxFileNumberStr &&
                matchAustralianTaxFileNumberStr.length > 0
                  ? matchAustralianTaxFileNumberStr.length
                  : 0) +
                (matchAustrianBankAccountNumbersStr &&
                matchAustrianBankAccountNumbersStr.length > 0
                  ? matchAustrianBankAccountNumbersStr.length
                  : 0) +
                (matchAustrianPassportNumberStr &&
                matchAustrianPassportNumberStr.length > 0
                  ? matchAustrianPassportNumberStr.length
                  : 0) +
                (matchAustrianSocialSecurityInsuranceNumberStr &&
                matchAustrianSocialSecurityInsuranceNumberStr.length > 0
                  ? matchAustrianSocialSecurityInsuranceNumberStr.length
                  : 0) +
                (matchAustrianVATNumberStr &&
                matchAustrianVATNumberStr.length > 0
                  ? matchAustrianVATNumberStr.length
                  : 0) +
                (matchCanadianAlbertaDriversLicenseStr &&
                matchCanadianAlbertaDriversLicenseStr.length > 0
                  ? matchCanadianAlbertaDriversLicenseStr.length
                  : 0) +
                (matchCanadianAlbertaHealthStr &&
                matchCanadianAlbertaHealthStr.length > 0
                  ? matchCanadianAlbertaHealthStr.length
                  : 0) +
                (matchCanadianManitobaDriversLicenseStr &&
                matchCanadianManitobaDriversLicenseStr.length > 0
                  ? matchCanadianManitobaDriversLicenseStr.length
                  : 0) +
                (matchCanadianManitobaHealthStr &&
                matchCanadianManitobaHealthStr.length > 0
                  ? matchCanadianManitobaHealthStr.length
                  : 0) +
                (matchCanadianOntarioDriversLicenseStr &&
                matchCanadianOntarioDriversLicenseStr.length > 0
                  ? matchCanadianOntarioDriversLicenseStr.length
                  : 0) +
                (matchCanadianOntarioHealthStr &&
                matchCanadianOntarioHealthStr.length > 0
                  ? matchCanadianOntarioHealthStr.length
                  : 0) +
                (matchCanadianPassportStr && matchCanadianPassportStr.length > 0
                  ? matchCanadianPassportStr.length
                  : 0) +
                (matchCanadianQuebecDriversLicenseStr &&
                matchCanadianQuebecDriversLicenseStr.length > 0
                  ? matchCanadianQuebecDriversLicenseStr.length
                  : 0) +
                (matchCanadianQuebecHealthStr &&
                matchCanadianQuebecHealthStr.length > 0
                  ? matchCanadianQuebecHealthStr.length
                  : 0) +
                (matchCanadianSaskatchewanDriversLicenseStr &&
                matchCanadianSaskatchewanDriversLicenseStr.length > 0
                  ? matchCanadianSaskatchewanDriversLicenseStr.length
                  : 0) +
                (matchCanadianSocialInsuranceNumberStr &&
                matchCanadianSocialInsuranceNumberStr.length > 0
                  ? matchCanadianSocialInsuranceNumberStr.length
                  : 0) +
                (matchDateFormatsStr && matchDateFormatsStr.length > 0
                  ? matchDateFormatsStr.length
                  : 0) +
                (matchFranceDriversLicenseNumberStr &&
                matchFranceDriversLicenseNumberStr.length > 0
                  ? matchFranceDriversLicenseNumberStr.length
                  : 0) +
                (matchFrancePassportNumberStr &&
                matchFrancePassportNumberStr.length > 0
                  ? matchFrancePassportNumberStr.length
                  : 0) +
                (matchFranceVATNumberStr && matchFranceVATNumberStr.length > 0
                  ? matchFranceVATNumberStr.length
                  : 0) +
                (matchFrenchINSEECodeStr && matchFrenchINSEECodeStr.length > 0
                  ? matchFrenchINSEECodeStr.length
                  : 0) +
                (matchGermanDriversLicenseNumberStr &&
                matchGermanDriversLicenseNumberStr.length > 0
                  ? matchGermanDriversLicenseNumberStr.length
                  : 0) +
                (matchGermanIDNumberStr && matchGermanIDNumberStr.length > 0
                  ? matchGermanIDNumberStr.length
                  : 0) +
                (matchGermanPassportNumberStr &&
                matchGermanPassportNumberStr.length > 0
                  ? matchGermanPassportNumberStr.length
                  : 0) +
                (matchGermanSocialSecurityNumberStr &&
                matchGermanSocialSecurityNumberStr.length > 0
                  ? matchGermanSocialSecurityNumberStr.length
                  : 0) +
                (matchGermanTaxIdentifierStr &&
                matchGermanTaxIdentifierStr.length > 0
                  ? matchGermanTaxIdentifierStr.length
                  : 0) +
                (matchIndianAadhaarNumberStr &&
                matchIndianAadhaarNumberStr.length > 0
                  ? matchIndianAadhaarNumberStr.length
                  : 0) +
                (matchIndianPANStr && matchIndianPANStr.length > 0
                  ? matchIndianPANStr.length
                  : 0) +
                (matchItalianPassportNumberStr &&
                matchItalianPassportNumberStr.length > 0
                  ? matchItalianPassportNumberStr.length
                  : 0) +
                (matchItalianTaxIDStr && matchItalianTaxIDStr.length > 0
                  ? matchItalianTaxIDStr.length
                  : 0) +
                (matchTurkishIDStr && matchTurkishIDStr.length > 0
                  ? matchTurkishIDStr.length
                  : 0) +
                (matchUKBICNumberStr && matchUKBICNumberStr.length > 0
                  ? matchUKBICNumberStr.length
                  : 0) +
                (matchUKDriverLicenseNumberStr &&
                matchUKDriverLicenseNumberStr.length > 0
                  ? matchUKDriverLicenseNumberStr.length
                  : 0) +
                (matchUKElectoralRollNumberStr &&
                matchUKElectoralRollNumberStr.length > 0
                  ? matchUKElectoralRollNumberStr.length
                  : 0) +
                (matchUKIBANNumberStr && matchUKIBANNumberStr.length > 0
                  ? matchUKIBANNumberStr.length
                  : 0) +
                (matchUKNHSNumberStr && matchUKNHSNumberStr.length > 0
                  ? matchUKNHSNumberStr.length
                  : 0) +
                (matchUKNationalInsuranceNumberStr &&
                matchUKNationalInsuranceNumberStr.length > 0
                  ? matchUKNationalInsuranceNumberStr.length
                  : 0) +
                (matchUKPassportNumberStr && matchUKPassportNumberStr.length > 0
                  ? matchUKPassportNumberStr.length
                  : 0) +
                (matchUKPostcodeStr && matchUKPostcodeStr.length > 0
                  ? matchUKPostcodeStr.length
                  : 0) +
                (matchUKSEDOLStr && matchUKSEDOLStr.length > 0
                  ? matchUKSEDOLStr.length
                  : 0) +
                (matchUKSortCodeStr && matchUKSortCodeStr.length > 0
                  ? matchUKSortCodeStr.length
                  : 0) +
                (matchUKUTRStr && matchUKUTRStr.length > 0
                  ? matchUKUTRStr.length
                  : 0) +
                (matchUSDriverLicenseNumberStr &&
                matchUSDriverLicenseNumberStr.length > 0
                  ? matchUSDriverLicenseNumberStr.length
                  : 0) +
                (matchUSITINStr && matchUSITINStr.length > 0
                  ? matchUSITINStr.length
                  : 0) +
                (matchUSMedicareHICNumberStr &&
                matchUSMedicareHICNumberStr.length > 0
                  ? matchUSMedicareHICNumberStr.length
                  : 0) +
                (matchUSPassportNumberStr && matchUSPassportNumberStr.length > 0
                  ? matchUSPassportNumberStr.length
                  : 0) +
                (matchUSSSNStr && matchUSSSNStr.length > 0
                  ? matchUSSSNStr.length
                  : 0) +
                (matchUSSSNRandomizationStr &&
                matchUSSSNRandomizationStr.length > 0
                  ? matchUSSSNRandomizationStr.length
                  : 0) +
                (matchUSVINStr && matchUSVINStr.length > 0
                  ? matchUSVINStr.length
                  : 0) +
                (matchUSZipCodeStr && matchUSZipCodeStr.length > 0
                  ? matchUSZipCodeStr.length
                  : 0) +
                (matchChinaTINStr && matchChinaTINStr.length > 0
                  ? matchChinaTINStr.length
                  : 0) +
                (matchJapanSSNStr && matchJapanSSNStr.length > 0
                  ? matchJapanSSNStr.length
                  : 0) +
                (matchKoreaRRNStr && matchKoreaRRNStr.length > 0
                  ? matchKoreaRRNStr.length
                  : 0) +
                (matchIRDStr && matchIRDStr.length > 0
                  ? matchIRDStr.length
                  : 0) +
                (matchSSSStr && matchSSSStr.length > 0
                  ? matchSSSStr.length
                  : 0) +
                (matchINSZStr && matchINSZStr.length > 0
                  ? matchINSZStr.length
                  : 0) +
                (matchStNrStr && matchStNrStr.length > 0
                  ? matchStNrStr.length
                  : 0) +
                (matchNIRStr && matchNIRStr.length > 0
                  ? matchNIRStr.length
                  : 0) +
                (matchCodiceFiscaleStr && matchCodiceFiscaleStr.length > 0
                  ? matchCodiceFiscaleStr.length
                  : 0) +
                (matchBSNStr && matchBSNStr.length > 0
                  ? matchBSNStr.length
                  : 0) +
                (matchNISSStr && matchNISSStr.length > 0
                  ? matchNISSStr.length
                  : 0) +
                (matchINNStr && matchINNStr.length > 0
                  ? matchINNStr.length
                  : 0) +
                (matchNUSSStr && matchNUSSStr.length > 0
                  ? matchNUSSStr.length
                  : 0) +
                (matchINPPStr && matchINPPStr.length > 0
                  ? matchINPPStr.length
                  : 0) +
                (matchCPFStr && matchCPFStr.length > 0
                  ? matchCPFStr.length
                  : 0) +
                (checkForWordsStr && checkForWordsStr.length > 0
                  ? checkForWordsStr.length
                  : 0);
                  ...
                  chrome.storage.sync.get(
                    ...
                    function (result) {
                      if (chrome.runtime.lastError) {
                        ...
                        debug(
                          "Retrieved enabled functions:",
                          result.enabledFunctions
                        );
...
function showPopup(event, wordx) {
  ...
  if (Array.isArray(wordx)) {
    ...
    forbiddenWordsList = wordx
      .map((word) => `<li class="dot-list">${word}</li>`)
      .join("");
